...
**Stage 10b Expanding-Window Evaluation complete.** The regression pipeline now supports repeated expanding-window model selection and evaluation in addition to the Stage 10a holdout. Tests verify non-overlapping forecast coverage, strict train-before-test ordering, final partial-fold handling, chronological rejection, tail thresholds, and coefficient alignment. The next stage should translate average, fold, and tail results into explicit acceptance criteria and stakeholder-facing risk communication.
